...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'mjlah' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'mjlah' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'mjlah' ),
			'200'       => esc_html__( 'Light 200', 'mjlah' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'mjlah' ),
			'300'       => esc_html__( 'Book 300', 'mjlah' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'mjlah' ),
			'400'       => esc_html__( 'Normal 400', 'mjlah' ),
			'regular'   => esc_html__( 'Normal 400', 'mjlah' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'mjlah' ),
			'500'       => esc_html__( 'Medium 500', 'mjlah' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'mjlah' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'mjlah' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'mjlah' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'mjlah' ),
			'700'       => esc_html__( 'Bold 700', 'mjlah' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'mjlah' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'mjlah' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'mjlah' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'mjlah' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'mjlah' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'mjlah' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'mjlah' ),
		);
	}
