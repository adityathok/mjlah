	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'mjlah' ),
				'remove'               => esc_html__( 'Remove', 'mjlah' ),
				'default'              => esc_html__( 'Default', 'mjlah' ),
				'selectFile'           => esc_html__( 'Select File', 'mjlah' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'mjlah' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'mjlah' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'mjlah' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'mjlah' ),
			)
		);
