...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'mjlah' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'mjlah' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'mjlah' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'mjlah' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'mjlah' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'mjlah' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'mjlah' ); ?>',
} );
#>
