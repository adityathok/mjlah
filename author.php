		...
		<div class="row">
			...
			<main class="site-main" id="main">
				...
				<header class="page-header author-header block-customizer">
					...
					<h1><?php echo esc_html__( 'About:', 'mjlah' ) . ' ' . esc_html( $curauth->nickname ); ?></h1>
					...
					<?php if ( ! empty( $curauth->user_url ) || ! empty( $curauth->user_description ) ) : ?>
						<dl>
							<?php if ( ! empty( $curauth->user_url ) ) : ?>
								<dt><?php esc_html_e( 'Website', 'mjlah' ); ?></dt>
								<dd>
							...
							<?php if ( ! empty( $curauth->user_description ) ) : ?>
								<dt><?php esc_html_e( 'Profile', 'mjlah' ); ?></dt>
								<dd><?php echo esc_html( $curauth->user_description ); ?></dd>
							<?php endif; ?>
						</dl>
					<?php endif; ?>

					<h2><?php echo esc_html__( 'Posts by', 'mjlah' ) . ' ' . esc_html( $curauth->nickname ); ?>:</h2>
						...
						while ( have_posts() ) {
							...
							echo '<li>';
								printf(
									...
									esc_attr( __( 'Permanent Link:', 'mjlah' ) ),
									get_the_title()
								);
								mjlah_posted_on();
								esc_html_e( 'in', 'mjlah' );
